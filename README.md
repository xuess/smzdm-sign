```
2019年02月24日 更新，近期发现使用此插件，会有官方冻结账号一周的风险，请请谨慎使用。
2019年03月08日 经发现家居生活栏目， 300-550的页面已经被官方清理，无法找到评论内容，只能使用默认的内容，默认的十条爆料，评论内容过多，容易被发现。所以评论内容选择变成 家居生活 发现频道 30 - 100 页 随机页数。也可以自行修改。希望看到后更新本项目。
```
